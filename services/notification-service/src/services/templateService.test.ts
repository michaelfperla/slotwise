...
import { TemplateName, templateService } from './templateService'; // Assuming TemplateName is exported
...
describe('TemplateService', () => {
  ...
  const testCases: {
    ...
    },
    {
      ...
      expectedStrings: [
        'Hello John Doe',
        'your booking for Awesome Haircut with Cool Cuts Inc. has been cancelled',
        'BK123',
        'Changed my mind',
    ...
    },
    {
      ...
      expectedStrings: [
        'Hello Jane Owner',
        'A booking for your service Awesome Haircut',
        'BK123',
  ...
  it('should throw an error for a non-existent template if not preloaded and filename convention fails', async () => {
    ...
    await expect(
      templateService.render('non-existent-template' as TemplateName, {})
