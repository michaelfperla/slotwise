...
export async function businessRoutes(fastify: FastifyInstance) {
  ...
  }, async (request: FastifyRequest<{ Body: z.infer<typeof createBusinessSchema> }>, reply: FastifyReply) => {
  ...
  }, async (request: FastifyRequest<{ Params: z.infer<typeof businessParamsSchema> }>, reply: FastifyReply) => {
